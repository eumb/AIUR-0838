...
class UR3_Robot:
    ...
    def open_gripper_script(self):
        print("Opening gripper")
        file_name = "/Projects/AIUR-0838-master/app/ur3e_library/grip_open"
        try:
    ...
    def close_griper_script(self):
        print("Closing gripper")

        file_name = "/Projects/AIUR-0838-master/app/ur3e_library/grip_close"
        try:
            f = open(file_name, "rb")  # Robotiq Gripper
        except IOError:
            print("Error: File does not appear to exist.")
